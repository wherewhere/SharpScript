...
namespace winrt::SharpScript::WinRT::implementation
{
    ...
    struct HookWindowingModel : HookWindowingModelT<HookWindowingModel>
    {
        ...
        static void WindowingModel(SharpScript::WinRT::WindowingModel value) { windowingModel = value; }
...
namespace winrt::SharpScript::WinRT::factory_implementation
{
